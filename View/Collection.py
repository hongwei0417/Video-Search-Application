...
def create():
        ...
        item1.setImg('https://i.ytimg.com/vi/wKpB5sn17T0/hqdefault.jpg?sqp=-oaymwEZCNACELwBSFXyq4qpAwsIARUAAIhCGAFwAQ==&rs=AOn4CLCUOz12pkNeaPFOt4T_mep2W4IJ7g')
        item1.setInfo('季彥霖 - 多想愛你『也許命中註定，他比我適合你。』【動態歌詞Lyrics】', 'EHPMusicChannel', '觀看次數：8,851,509次', '木棉花Youtube頻道動畫線上免費看訂閱木棉花以獲得最新訊息http://bit.ly/Muse-TW_YTChannel J市海邊有一群自稱是深海族的怪人 ...')
        item1.setPos(20, 20)
        item1.load()

        item2 = VideoItem(frame)
        item2.setImg('https://i.ytimg.com/vi/wKpB5sn17T0/hqdefault.jpg?sqp=-oaymwEZCNACELwBSFXyq4qpAwsIARUAAIhCGAFwAQ==&rs=AOn4CLCUOz12pkNeaPFOt4T_mep2W4IJ7g')
        ...
        item3.setImg('https://i.ytimg.com/vi/wKpB5sn17T0/hqdefault.jpg?sqp=-oaymwEZCNACELwBSFXyq4qpAwsIARUAAIhCGAFwAQ==&rs=AOn4CLCUOz12pkNeaPFOt4T_mep2W4IJ7g')
